...
public class EndNode extends ChartGraphNode {
    ...
    public EndNode(Double fontSize, Double radius) {
    ...
    public void setOffset(DoubleCoordinates offset) {
        ...
        //relationPoints.get(Direction.NORTH).add(new DoubleCoordinates(offset.getX(), offset.getY() - radius));
    }
    ...
    public String asSvg() {
        return "  <circle\r\n"
                ...
                + "         style=\"font-size:"+fontSize.intValue() + ";letter-spacing:-0.00264583px;word-spacing:0px;stroke-width:0.26458332;text-anchor:middle;text-align:center\">f</tspan></text>";
    }
